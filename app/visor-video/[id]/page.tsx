  ...
  useEffect(() => {
    ...
    if (isPlaying && inspeccion) {
      interval = setInterval(() => {
        ...
        setCurrentAngle((prev) => (prev + 2) % 360) // Simulate angle changes
      }, 1000)
    }
                ...
                <div className="relative bg-muted aspect-video flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-white text-lg font-semibold">Video de Inspección</p>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{currentAngle}°</p>
                  </div>
                </div>
