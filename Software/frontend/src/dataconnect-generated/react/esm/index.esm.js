import { createNewProjectRef, listAllProjectsRef, updateInspectionStatusRef, getMediaAssetsByInspectionIdRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useUpdateInspectionStatus(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
...
export function useGetMediaAssetsByInspectionId(dcOrVars, varsOrOptions, options) {
